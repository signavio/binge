...
var cli = meow([
    ...
    '  install    (?[moreYarnArgs, ...]) installs the local-package tree. If the',
    '             root node execution produced a dependency delta (with piped',
    '             yarn args), changes are applied to every reachable node that',
    ...
    '  prune',
    '  uninstall',
    'Hoisted Yan Commands follow these steps:',
    '  1- Hoist package.json',
    '  2- Call Yarn',
    '  3- Unhoist package.json, applying the resulting dependency delta',
    '  4- Command arguments are piped to yarn. Example binge uninstall react',
])
